...
List<Map<String, dynamic>> livrosData = [
  {
    "id": 1,
    ...
    "download_url": "https://www.gutenberg.org/ebooks/72134.epub3.images",
        ...
        "cover_url": "http://www.gutenberg.org/cache/epub/72127/pg72127.cover.medium.jpg",
        "download_url": "http://www.gutenberg.org/ebooks/72127.epub.images"
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "download_url": "https://gutenberg.org/ebooks/72133.epub3.images"
    }
  // Adicione os outros livros aqui...
];
Future<List<Livro>> baixarListaDeLivros() async {
  // Simule uma resposta HTTP com os dados da lista de livros
  final resposta = jsonEncode(livrosData);

  final List<dynamic> livrosJson = json.decode(resposta);

  final livros = livrosJson.map((livro) => Livro.fromJson(livro)).toList();
